                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id=""
                                        aria-describedby="helpId" placeholder="Enter the name"
                                        value="{{ $object->name }}" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" name="email"
                                        placeholder="name@example.com" value="{{ $object->email }}"
                                        autocomplete="email">
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <!--begin::Edit button-->
                            <label
                                class="btn btn-icon btn-circle btn-color-muted btn-active-color-primary w-25px h-25px bg-body"
