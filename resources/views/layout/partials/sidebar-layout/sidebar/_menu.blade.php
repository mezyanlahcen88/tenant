    ...
    <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true"
        ...
        <div class="menu menu-column menu-rounded menu-sub-indention px-3 fw-semibold fs-6" id="#kt_app_sidebar_menu"
            ...
            <div class="menu-item">
                ...
                <!--end:Menu link events-->
            </div>
            <!--end:Menu item-->
            <!--begin:Menu item-->
            <div class="menu-item">
                <!--begin:Menu link documents-->
                <a class="menu-link" href="https://preview.keenthemes.com/html/metronic/docs/base/utilities"
                    target="_blank">
                    <span class="menu-icon">{!! getIcon('file', 'fs-2') !!}</span>
                    <span class="menu-title">Documents</span>
                </a>
                <!--end:Menu link documents-->
            </div>
            <!--end:Menu item-->
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        ...
                        <a class="menu-link {{ request()->routeIs('user-management.users.*') ? 'active' : '' }}"
                            ...
                            <span class="menu-title">Offline Payments</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        ...
                        <a class="menu-link {{ request()->routeIs('user-management.users.*') ? 'active' : '' }}"
                            ...
                            <span class="menu-title">Supports tickets</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
                    ...
                    <div class="menu-item">
                        ...
                        <a class="menu-link {{ request()->routeIs('user-management.roles.*') ? 'active' : '' }}"
                            ...
                            <span class="menu-title">Show Announcement List</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
