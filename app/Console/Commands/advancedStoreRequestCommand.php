...
class advancedStoreRequestCommand extends Command
{
    protected $signature = 'make:module-storeRequest {name : The name of the form request}';
    ...
    public function handle()
    {
        ...
        $stub = File::get(app_path('Console/Commands/stubs/storeRequest.stub'));
        ...
        $filePath = base_path('Modules/'.$modelName.'/App/Http/Requests/Store' . $name. 'Request.php');
